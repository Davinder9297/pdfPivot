    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-forest mb-2">Convert Images to PDF</h1>
          <p className="text-lg text-black max-w-2xl mx-auto">
            Upload one or more images and convert them into a single PDF file. Each image will be a separate page.
          </p>
        </div>
                ...
                <div>
                  ...
                  >
                    <div className="space-y-1 text-center">
                      ...
                      <p className="text-xs text-gray-500">JPG, JPEG, or PNG up to 20MB each</p>
                      {files.length > 0 && (
                        <div className="mt-2">
