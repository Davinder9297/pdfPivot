...
const PptToPdfPage = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:5000/api/ppt-to-pdf', {
        method: 'POST',
        body: formData,
      });
      ...
      setError(error.message || 'Failed to convert presentation. Please make sure the server is running.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-forest mb-2">Convert PPT to PDF</h1>
          <p className="text-lg text-black max-w-2xl mx-auto">
            Upload a PowerPoint presentation (.ppt or .pptx) and convert it to PDF format while preserving the presentation layout.
          </p>
        </div>
                ...
                <div>
                  ...
                  >
                    <div className="space-y-1 text-center">
                      ...
                      <p className="text-xs text-gray-500">PPT or PPTX up to 20MB</p>
                      {file && (
                        <div className="mt-2">
