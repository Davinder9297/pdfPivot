    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-forest mb-2">Convert Word to PDF</h1>
          <p className="text-lg text-black max-w-2xl mx-auto">
            Upload a Word document (.doc or .docx) and convert it to PDF format while preserving formatting.
          </p>
        </div>
                ...
                <div>
                  ...
                  >
                    <div className="space-y-1 text-center">
                      ...
                      <p className="text-xs text-gray-500">DOC or DOCX up to 20MB</p>
                      {file && (
                        <div className="mt-2">
