...
const PdfToExcelPage = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      setError(error.message || 'Failed to convert PDF file. Make sure the server is running.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-green-700 mb-2">Convert PDF to Excel</h1>
          <p className="text-lg text-black max-w-2xl mx-auto">
            Upload a PDF file and convert it to Excel format (.xlsx) preserving the data structure.
          </p>
        </div>
