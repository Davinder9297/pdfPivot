...
const RemovePdfPage = () => {
  ...
  const handleRemovePages = async () => {
    ...
    try {
      ...
      if (pages.length === 0) {
        setError("Please enter at least one page number to remove.");
        setLoading(false);
        return;
      }
      ...
      if (pagesToRemove.length === 0) {
        setError("Invalid page numbers. Please enter numbers between 1 and " + pageCount);
        setLoading(false);
        return;
      }
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-forest mb-2">Remove PDF Pages</h1>
          <p className="text-lg text-black max-w-2xl mx-auto">
            Upload a PDF and remove specific pages. Enter page numbers separated by commas (e.g., 1,3,5).
          </p>
        </div>
