  ...
  return (
    <section className="w-full py-16 bg-indigo-900 flex flex-col items-center">
      <div className="w-full max-w-4xl text-center px-4 py-12">
        ...
        The PDF toolkit trusted by thousands of users
        </h2>
        <p className="text-white mb-10 text-base md:text-lg">
        PDFPivot is your secure, all-in-one platform for converting, editing, and organizing PDF files. Fast performance, private processing — no data stored.
        </p>
        <div className="flex justify-center items-center space-x-10 mt-8">
          ...
          <div className="flex flex-col items-center">
            ...
            <span className="text-xs text-white">Trusted by Enterprises</span>
          </div>
        </div>
      </div>
    </section>
